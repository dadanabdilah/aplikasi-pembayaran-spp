      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a class="nav-item nav-link btn btn-primary" href="/login" data-toggle="modal" data-target="#loginModalCenter">Login</a>
            <!-- <a class="nav-item nav-link btn btn-primary" data-toggle="modal" data-target="#loginModalCenter">Login</a> -->
          </div>
        </div>
      </div>
    </nav>
