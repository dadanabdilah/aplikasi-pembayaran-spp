...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo menu-item hidden"><a href="https://codeigniter.com" target="_blank">e-Pembayaran SPP</a>
			</li>
	...
	<div class="heroe">
		...
		<h2>Ini adalah system informasi pembayaran SPP.	</h2>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; 2021 - <?= date('Y') ?> RPL SMKN 2 Kuningan</p>
